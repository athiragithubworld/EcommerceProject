...
const About = () =>{
    ...
    return(
        ...
        <div>
            ...
            ></img>
        <p className={classes.paragraph}> Lorem ipsum carrots enhanced rebates. Excellent sayings of a man 
            ...
            will never be the trouble and they are refused to the pleasures and 
